...
Please insert your individual key. 
...
The second one contains links regarding the first, self (actual scraped page), next and last page. In the last one also information about pages and results is given. There are ``r Ex3_first_glimpse[["page"]][["totalPages"]]`` pages with ``r Ex3_first_glimpse[["page"]][["size"]]`` elements each (in total: ``r Ex3_first_glimpse[["page"]][["totalElements"]]`` elements).
