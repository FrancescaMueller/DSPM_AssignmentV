...
```{r visualization_DE}
# Prepare data frame
# Ex4 <- Ex4 %>% filter(between(longitude, 5.86694, 15.043611)) # No, want to keep as NA
Ex4 <- Ex4_all
Ex4[ , 6][Ex4[, 6] != range(5.86694, 15.043611)] <- NA  # longitude
Ex4[ , 7][Ex4[, 7] != range(47.271679, 55.0846)] <- NA  # latitude
# test <- Ex4[complete.cases(Ex4[ , 6:7]),]
