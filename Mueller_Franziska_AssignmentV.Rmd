...
# Note looping pages: counting from 0 to 611, in total 612 pages
# Idea: keep 612 pages and just cut it in the end
...
# Choosing a small country with fewer observations 
# Monaco: no, nearly no data regarding long/lat
# Try Belgium
...
# Repeat Ex.3
Ex3_first_glimpse_BE <- first_glimpse("BE", 0)  # small data set
```
...
m_BE <- as.numeric(Ex5_first_glimpse[["page"]][["totalElements"]])
