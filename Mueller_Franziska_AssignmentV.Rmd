...
all_pages <- function(country, number_pages, df_all_pages) {
  ...
  Sys.sleep(time = 5/60)  # 5 requests per second
  }
  return(df_all_pages)
  }
...
Ex4_9 <- all_pages(country, 9, df_Ex4)  # FEHLER -> no location, can`t select it
Ex4_10 <- all_pages(country, 10, df_Ex4)  # location does not exist
Ex4_15 <- all_pages(country, 15, df_Ex4)  # location does not exist
